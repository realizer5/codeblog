...
const Input = ({ label, type = "text", className = "", divClass = "", ...props }, ref) => { // didn't added props to input and it was causing error without any description or hind and form was not submiting cuz i was adding in props when calling this annoying error
    const id = useId();
