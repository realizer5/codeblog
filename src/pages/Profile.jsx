        ...
        <Container className="my-10">
            ...
            <form onSubmit={handleSubmit(submit)} className="mt-10 flex flex-col justify-center items-center gap-10">
                ...
                <div className="group relative w-fit m-auto flex justify-center items-center">
                    {editable &&
                        <>
                            <Input type="file" className="opacity-0 absolute inset-0 cursor-pointer z-10" accept="image/png, image/jpg, image/jpeg"
                                {...register("image")} />
                            <Pencil className="absolute group-hover:opacity-100 opacity-0 duration-200 z-0" />
                        </>
                    }
